        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Every day, businesses lose thousands of dollars because their links stop working. Product pages go offline, domains expire,
              and redirect chains break—leaving customers frustrated and revenue flowing to competitors.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Average revenue lost due to broken affiliate and marketing links</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Dead links damage trust and drive customers to competitors</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Manual link checking wastes time and still misses critical failures</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Our intelligent platform continuously monitors your links, automatically detects failures, and keeps your revenue flowing with
              smart backup routing and instant alerts.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Continuous monitoring catches broken links within minutes, not days</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Convert failed clicks into sales with intelligent fallback strategies</p>
                </div>
              </div>
            </div>
