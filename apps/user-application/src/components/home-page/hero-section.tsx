    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-primary/5 py-20 sm:py-28">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          {/* Badge */}
          <Badge variant="outline" className="mb-6 px-4 py-2 text-sm font-medium bg-primary/5 border-primary/20 text-primary">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            ...
            <span className="bg-gradient-to-r from-primary via-primary to-purple-600 bg-clip-text text-transparent">Broken Links</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Smart link management with AI monitoring and geo-routing that keeps your traffic flowing and revenue growing.
          </p>
