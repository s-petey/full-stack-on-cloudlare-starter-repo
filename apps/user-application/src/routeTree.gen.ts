...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/app' | '/app/create' | '/app/evaluations' | '/app/links' | '/app/' | '/app/link/$id';
  fileRoutesByTo: FileRoutesByTo;
  to: '/' | '/app' | '/app/create' | '/app/evaluations' | '/app/links' | '/app/link/$id';
  id:
    | '__root__'
    | '/'
    | '/app'
...
const AppAuthedRouteWithChildren = AppAuthedRoute._addFileChildren(AppAuthedRouteChildren);
